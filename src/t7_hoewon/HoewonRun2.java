...
//						else System.out.println("가입 가능한 연령은 20세 이상입니다. 다시 입력하세요.");
//					}
						...
						if(vo.getName() == null) {
							...
							switch(num) {
								...
								case 2:
									...
									break;
								case 3:
									System.out.print("수정할 성별을 입4력하세요.(1.남자, 2.여자)");
							...
							res = dao.setHoewonUpdate(name,age,address,strGender);	//회원정보 수정 메소드 호출
